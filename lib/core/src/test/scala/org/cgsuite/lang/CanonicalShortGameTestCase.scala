...
object CanonicalShortGameTestCase {
  ...
  val instances = Seq(
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "25/16",
      followerCount = "7",
      followers = Some("{0,1,3/2,25/16,13/8,7/4,2}"),
      freeze = "25/16",
      incentives = "{-1/16}",
      isAllSmall = "false",
      isAtomic = "false",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "*8",
      followerCount = "9",
      followers = Some("{0,*,*2,*3,*4,*5,*6,*7,*8}"),
      freeze = "*8",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "9/8*",
      followerCount = "7",
      followers = Some("{0,1,9/8,5/4,3/2,2,9/8*}"),
      freeze = "9/8*",
      incentives = "{*}",
      isAllSmall = "false",
      isAtomic = "false",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "6^*",
      followerCount = "9",
      followers = Some("{0,1,2,3,4,5,6,6*,6^*}"),
      freeze = "6^*",
      incentives = "{^*}",
      isAllSmall = "false",
      isAtomic = "false",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "^*6",
      followerCount = "9",
      followers = Some("{0,*,*2,*3,*4,*5,*6,*7,^*6}"),
      freeze = "^*6",
      incentives = "{^*}",
      isAllSmall = "true",
      isAtomic = "true",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "{0,*||*|v3*}",
      followerCount = "7",
      followers = Some("{0,*,v3,vv*,v,{0|v3},{0||0|v3}}"),
      freeze = "{0||0|v3}",
      incentives = "{{^3,{^3|0}|0}}",
      isAllSmall = "true",
      isAtomic = "true",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "{0,*||*|-3/2}",
      followerCount = "6",
      followers = Some("{-2,-3/2,-1,0,{0|-3/2},Tiny(3/2)}"),
      freeze = "Tiny(3/2)",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "{0,*|||*||-1|-3}",
      followerCount = "7",
      followers = Some("{-3,-2,-1,0,{-1|-3},{0||-1|-3},Tiny({3|1})}"),
      freeze = "Tiny({3|1})",
    ...
    CanonicalShortGameTestCase(
      ...
      companion = "{3||2*|1*}",
      followerCount = "8",
      followers = Some("{0,1,2,3,1*,2*,{3||2*|1*},{2*|1*}}"),
      freeze = "9/4*",
      incentives = "{{2*|1*||0}}",
      isAllSmall = "false",
      isAtomic = "false",
