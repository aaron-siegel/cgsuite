...
object CanonicalShortGameTestCase {
  ...
  val instances = Seq(
    ...
    CanonicalShortGameTestCase(
      ...
      birthday = "6",
      companion = "{0,*|||*||-1|-3}",
      incentives = "{{3+{3|1}.Tiny|1+{3|1}.Tiny,{2,{3|1}|0}||0}}",
      isAllSmall = "false",
      isAtomic = "true",
      isEven = "false",
      isEvenTempered = "false",
      ...
      isUptimal = "false",
      isZero = "false",
      leftIncentives = "{{3|1}.Miny}",
      leftOptions = "{0}",
      leftStop = "0",
      mean = "0",
      reducedCanonicalForm = "0",
      rightIncentives = "{{3+{3|1}.Tiny|1+{3|1}.Tiny,{2,{3|1}|0}||0}}",
      rightOptions = "{{0||-1|-3}}",
      rightStop = "0",
      stopCount = "4",
      temperature = "0",
    ...
    CanonicalShortGameTestCase(
      ...
      birthday = "8",
      companion = "{5||3|1|||*||||0,*}",
      incentives = "{{5+{5||3|1}.Tiny|{3,{3|1}|||3|1||0|-2,{-2|-4}},{{4|2},{5||3|1}|0}||0}}",
      isAllSmall = "false",
      isAtomic = "true",
      isEven = "false",
      isEvenTempered = "false",
      ...
      isUptimal = "false",
      isZero = "false",
      leftIncentives = "{{5+{5||3|1}.Tiny|{3,{3|1}|||3|1||0|-2,{-2|-4}},{{4|2},{5||3|1}|0}||0}}",
      leftOptions = "{{5||3|1|||0}}",
      leftStop = "0",
      mean = "0",
      reducedCanonicalForm = "0",
      rightIncentives = "{{5||3|1}.Miny}",
      rightOptions = "{0}",
      rightStop = "0",
      stopCount = "5",
      temperature = "0",
