...
public class CgsuiteLanguageHierarchy extends LanguageHierarchy<CgsuiteTokenId>
{
    ...
    static
    {
        ...
        tokenTypes.put("keyword", new int[]
        {
            ...
            FALSE, FINALLY, FOR, FOREACH, FROM, GET, IF, IN, IS, JAVA, LISTOF, METHOD, MUTABLE, NEG,
            NIL, NOT, OP, OR, OVERRIDE, PASS, POS, PROPERTY, RETURN,
        ...
        tokenTypes.put("separator", new int[]
        {
            ...
            TILDE, BANG, QUESTION, CARET, MULTI_CARET, VEE, MULTI_VEE, EQUALS, NEQ, LT, GT, LEQ, GEQ,
